...
extern void load_idt(struct idtr *idt_desc);
...
void init_idt() {
    ...
    set_idt_gate(32, (uint32_t)isr_timer_handler, 0x08, 0x8E);
...
void set_timer_freq(uint16_t freq) {
